\providecommand{\algname}{algorithme2 on bbob-biobj budget0200xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0200xD/}
...
\providecommand{\algname}{algorithme2 on bbob-biobj budget0100xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0100xD/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $51$ targets $10^{[-8..2]}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{algorithme2 on bbob-biobj budget0050xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0050xD/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $51$ targets $10^{[-8..2]}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{algorithme2 on bbob-biobj budget0020xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0020xD/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $51$ targets $10^{[-8..2]}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{algorithme2 on bbob-biobj budget0010xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0010xD/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $51$ targets $10^{[-8..2]}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{algorithme2 on bbob-biobj budget0005xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0005xD/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $51$ targets $10^{[-8..2]}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{algorithme2 on bbob-biobj budget0002xD{}}
\providecommand{\algfolder}{algorithme2_on_bbob-biobj_budget0002xD/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $51$ targets $10^{[-8..2]}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
